...
echo "1:info:$ssh lxc-info -n" > $lcomandos
echo "2:start:$ssh lxc-start -n" >> $lcomandos
echo "3:stop:$ssh lxc-stop -n" >> $lcomandos
echo "4:freeze:$ssh lxc-freeze -n" >> $lcomandos
echo "5:unfreeze:$ssh lxc-unfreeze -n" >> $lcomandos
echo "6:destroy:" >> $lcomandos

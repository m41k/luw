...
#Instalacoes
 ...
 #Preparando /opt/luw
  ...
  #Preparando /opt/luw/tools
   ...
   wget https://raw.githubusercontent.com/m41k/luw/master/opt/luw/tools/luw-logout.sh
   chmod +x *
  ...
  #Ambiente ADM -Organizar-
   ...
   wget https://raw.githubusercontent.com/m41k/luw/master/usr/lib/cgi-bin/luw-mdc.sh
   wget https://raw.githubusercontent.com/m41k/luw/master/opt/luw/tools/luw-images.sh
